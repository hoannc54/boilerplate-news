                ...
                <div class="card-block">
                    <form action="{{ route('admin.category.update', $category->id) }}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputCategory" name="title"
                                       value="{{ old('title', $category->title) }}" placeholder="Tên danh mục">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="inputCategory" name="slug"
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="inputParent" name="parent_id">
                                    @foreach($categories as $key => $title)
                                        <option value="{{ $key }}" @if($key === $category->parent_id) selected @endif>
                                            {{ $title }}
                                        </option>
                                    @endforeach
